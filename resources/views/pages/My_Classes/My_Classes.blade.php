    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <form action="{{ route('Classrooms.index') }}" method="GET">
                {{ csrf_field() }}
                <select class="selectpicker btn btn-success mb-4" data-style="btn-info" name="Grade_id" required
                        onchange="this.form.submit()">
                    <option value="" selected disabled>{{ trans('My_Classes_trans.Search_By_Grade') }}</option>
                    <option value="all">{{ trans('My_Classes_trans.Search_All_Grade') }}</option>
            ...
            <div class="table-responsive">
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                    ...
                    <thead>
                        <tr>
                            <th class="p-2"><input name="select_all" id="example-select-all" type="checkbox" onclick="CheckAll('box1', this)" /></th>
                            <th>#</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                        data-target="#edit{{ $My_Class->id }}" title="{{ trans('Grades_trans.Edit') }}"><i class="fa fa-edit"></i></button>
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                        data-target="#delete{{ $My_Class->id }}" title="{{ trans('Grades_trans.Delete') }}"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                                ...
                                <div data-repeater-item>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input class="btn btn-danger btn-block form-control" data-repeater-delete type="button" value="{{ trans('My_Classes_trans.delete_row') }}" style="background-color:#dc3545; border-color:#dc3545; color:white"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
